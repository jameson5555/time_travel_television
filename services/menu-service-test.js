describe('Menu service', function () {
    'use strict';
    var items, menuService, configurationConstants, $httpBackend, requestHandler;
    ...
    beforeEach(function () {
        ...
        inject(function ($injector) {
            ...
            configurationConstants = $injector.get('configurationConstants');
        ...
        requestHandler = $httpBackend.whenGET(configurationConstants.ITEMS_URL).respond(items);
    ...
    it('should fail to get a list of items', function () {
        requestHandler.respond(500, 'error');

        //expectations can be nested in promise resolutions.
        menuService.get().then(function (data) {
            throw 'The success callback should never execute.';
        }, function (data) {
    ...
    it('should get an item by id', function () {
        ...
        menuService.get('item_1').then(function (data) {
