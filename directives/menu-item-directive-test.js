...
describe('Menu item directive', function () {
    'use strict';
    var element, $rootScope, $compile, $httpBackend;
    ...
    beforeEach(function () {
        ...
        $httpBackend.whenGET('templates/menu-item-template.html').respond('<a href="#/{{item.id}}">{{item.name}}</a>');
        ...
        $rootScope.$apply(function () {
            ...
            element = $compile('<div menu-item-directive>')($rootScope);
        });
